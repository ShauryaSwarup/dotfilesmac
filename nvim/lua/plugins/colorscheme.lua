        ...
        highlight_overrides = {
          all = function(colors)
            ...
            return {
              ...
              NormalNC = { bg = bg },
              NormalFloat = { bg = bg },
              FloatBorder = { bg = bg, fg = colors.subtext1 },
              ...
              NeoTreeWinSeparator = { fg = colors.surface1, bg = bg },
              NeoTreeFloatBorder = { fg = bg, bg = bg },
              NeoTreeTabActive = { fg = colors.text, bg = bg },
              NeoTreeTabInactive = { fg = colors.surface2, bg = bg },
              NeoTreeTabSeparatorActive = { fg = bg, bg = bg },
              NeoTreeTabSeparatorInactive = { fg = bg, bg = bg },

              -- Telescope
              TelescopePromptBorder = { bg = bg, fg = colors.overlay0 },
              TelescopeResultsBorder = { bg = bg, fg = colors.overlay0 },
              TelescopePreviewBorder = { bg = bg, fg = colors.overlay0 },
              TelescopePromptTitle = { fg = colors.mantle, bg = "#39fd9c", style = { "bold" } },
              TelescopeResultsTitle = { link = "TelescopePromptTitle" },
              TelescopePreviewTitle = { link = "TelescopePromptTitle" },

              -- UI stuff
              VertSplit = { bg = bg, fg = colors.surface0 },
              CursorLineNr = { fg = colors.text },
              LineNr = { fg = colors.overlay0 },
